...
A frozen install is followed by `pnpm check` (typechecking, unit tests, panel interaction tests, recipe
...
typechecking, unit tests, panel interaction tests, recipe checks, and the same dependency audit before
